...
Мы конечно можем ввести данные для теста. Однако мы сейчас эту ошибку не обрабатываем. Поэтому в папке auth login.hbs гдени будь перед заголовком h1 я буду проверять.
